...
def _rewrite_phase16_quick_index(phase_root: Path, manifest: Dict[str, Any]) -> None:
...
def main() -> None:
    ...
    bundle_name = f"goc_traceops_phase16_{ts}_{bundle_id}"
    bundle_root = repo_root / "experiment_bundles" / bundle_name
    phase_root = bundle_root / "phase16"
    ...
    idx_lines = [
        f"# Phase16 TraceOps bundle: {bundle_name}",
        "",
        f"- model={args.model}",
    ...
    _rewrite_phase16_quick_index(phase_root, manifest)
